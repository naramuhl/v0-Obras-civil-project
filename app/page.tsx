          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Gastos e receitas dos últimos 6 meses.</CardDescription>
              </CardHeader>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Distribuição das ferramentas por estado.</CardDescription>
              </CardHeader>
              <CardContent className="pl-2">
                <ToolStatus />
              </CardContent>
        ...
        <TabsContent value="analytics" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Análise detalhada de gastos por categoria.</CardDescription>
            </CardHeader>
            <CardContent className="pl-2">
              <p>Conteúdo de análise detalhada será implementado aqui.</p>
            </CardContent>
          </Card>
        </TabsContent>
